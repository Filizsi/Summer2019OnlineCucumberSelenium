Feature: Login
  ...
  Scenario:Login as driver
    Given user is on the login page
    Then user login as "driver"

  @login_with_role
  Scenario:Login as store manager
    Given user is on the login page
    Then user login as "store manager"

  @login_with_role
  Scenario:Login as sales manager
    Given user is on the login page
    Then user login as "sales manager"

  @login_with_role_ddt
  Scenario Outline: Login as <role>
    Given user is on the login page
    Then user login as "<role>"
  ...
  Scenario Outline: Login as <role> and verify <title> page title is correct
    ...
    Examples: drivers
      ...
      | driver | System     | Contact Reasons | Contact Reasons - System                                               |
